...
type CmdFn =
    Arc<dyn Fn(Option<&str>, &mpsc::Sender<UserCommand>) -> SlashCommandResult + Send + Sync>;
...
pub fn register_builtin_commands(registry: &mut SlashCommandRegistry) {
    ...
    registry.register(user_command_cmd(
        "/mode",
        "/mode [default|accept-edits|bypass|plan|dont-ask]",
        "Set permission mode",
    ...
    registry.register(user_command_cmd(
        ...
        "/plan [description]",
        "Enter plan mode",
        |args| UserCommand::EnterPlan {
            description: args.map(|s| s.to_string()),
        },
    ));
    ...
    registry.register(user_command_cmd(
        ...
        |_| UserCommand::ShowConfig,
    ));
    registry.register(user_command_cmd(
        "/cost",
        "/cost",
        "Show cumulative usage cost",
        |_| UserCommand::ShowCost,
    ));
    registry.register(user_command_cmd(
        "/diff",
        "/diff",
        "Show workspace git diff",
        |_| UserCommand::ShowDiff,
    ));
    registry.register(user_command_cmd(
        "/doctor",
        "/doctor",
        "Diagnose environment",
        |_| UserCommand::ShowDoctor,
    ));
    registry.register(user_command_cmd(
        "/status",
        "/status",
        "Show status overview",
        |_| UserCommand::ShowStatus,
    ));
    registry.register(user_command_cmd(
        "/context",
        "/context",
        "Show context window usage",
        |_| UserCommand::ShowContext,
    ));
    registry.register(user_command_cmd(
        "/keybindings",
        "/keybindings",
        "Show keyboard shortcuts",
        |_| UserCommand::ShowKeybindings,
    ));
    ...
    registry.register(user_command_cmd(
        ...
        |_| UserCommand::InitProject,
    ));
    registry.register(user_command_cmd(
        "/rename",
        "/rename [name]",
        "Rename current session",
        |args| UserCommand::RenameSession {
            name: args.unwrap_or("").to_string(),
        },
    ));
    registry.register(user_command_cmd(
        "/rewind",
    ...
    registry.register(user_command_cmd(
        ...
        |args| UserCommand::AddDirectory {
            path: std::path::PathBuf::from(args.unwrap_or("")),
        },
    ));
    registry.register(user_command_cmd(
        "/branch",
        ...
        |args| UserCommand::BranchConversation {
            name: args.map(|s| s.to_string()),
        },
    ));
    ...
    registry.register(user_command_cmd(
        ...
        "/review [target]",
        "Review code changes",
        |args| UserCommand::Review {
            target: args.map(|s| s.to_string()),
        },
    ));
    ...
    registry.register(user_command_cmd(
        ...
        |_| UserCommand::LoginStatus,
    ));
    registry.register(user_command_cmd(
        "/logout",
        "/logout",
        "Clear local credentials",
        |_| UserCommand::Logout,
    ));
    ...
    registry.register(user_command_cmd(
        ...
        "Set model effort",
        |args| UserCommand::SetEffort {
            level: args.unwrap_or("").to_string(),
        },
    ));
    registry.register(user_command_cmd(
        "/theme",
        "/theme [name|reload]",
        "Switch or reload theme",
        |args| match args {
    ...
    registry.register(user_command_cmd(
        ...
        "/export [path]",
        "Export conversation",
        |args| UserCommand::ExportConversation {
    ...
    registry.register(user_command_cmd(
        ...
        |_| UserCommand::CopyLatestAssistant,
    ));
