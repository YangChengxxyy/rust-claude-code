...
The system SHALL provide a `/plugin remove <name>` slash command that unloads and removes a user-installed plugin by name. All plugin resources (MCP servers, agents, slash commands) SHALL be cleaned up.
